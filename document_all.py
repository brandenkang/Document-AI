...
def main(project_id='document-ai-project-291706',
        input_uri='gs://analysis_report_samples/하나.pdf'):
        #  input_uri='gs://cloud-samples-data/documentai/invoice.pdf'):

    # Process a single document with the Document AI API, including text extraction and entity extraction.
    ...
    file_= open('final_sample!!.text','w')
    ...
    #     file_.write('PAGE: {}'.format(page.page_number))
